...
public class IntellijDatasourceService {
    ...
    private static final String DATABASE_PLUGIN_NOT_INSTALLED = "database plugin is not installed.";
    private static final String NOT_SUPPORT_ERROR_ACTION = "database plugin is only provided in IntelliJ Ultimate edition.";
