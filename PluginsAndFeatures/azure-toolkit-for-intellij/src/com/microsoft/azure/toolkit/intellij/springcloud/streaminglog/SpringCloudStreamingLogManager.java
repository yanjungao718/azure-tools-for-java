...
public class SpringCloudStreamingLogManager {
    ...
    public void showStreamingLog(Project project, SpringCloudApp app, String instanceName) {
        ...
        final AzureText title = AzureOperationBundle.title("springcloud|log_stream.start", instanceName);
    ...
    public void closeStreamingLog(String instanceName) {
        final AzureText title = AzureOperationBundle.title("springcloud|log_stream.close", instanceName);
