...
package com.microsoft.azure.toolkit.intellij.springcloud.action;
...
import com.microsoft.azure.toolkit.intellij.springcloud.runner.SpringCloudConfigurationType;
...
public class DeploySpringCloudAction extends AzureAnAction {
    ...
    @Override
    @AzureOperation(name = "deploy spring cloud application", type = AzureOperation.Type.ACTION)
