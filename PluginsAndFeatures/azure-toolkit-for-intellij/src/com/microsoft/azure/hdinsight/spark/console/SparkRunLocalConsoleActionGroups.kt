...
//        group.add(ActionManager.getInstance().getAction("Actions.RunArcadiaSparkLocalConsoleAction"))
...
//class SelectArcadiaSparkTypeThenRunLocalConsoleAction : SeqActions("Actions.SelectArcadiaSparkType", "Spark.RunScalaLocalConsole")
