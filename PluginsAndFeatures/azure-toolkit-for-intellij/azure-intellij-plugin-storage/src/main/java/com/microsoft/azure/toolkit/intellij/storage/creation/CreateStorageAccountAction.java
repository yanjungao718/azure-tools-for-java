...
public class CreateStorageAccountAction {
    ...
    @AzureOperation(name = "storage.create_account", params = {"config.getName()"}, type = AzureOperation.Type.ACTION)
    public static void create(final StorageAccountConfig config) {
        final AzureString title = AzureOperationBundle.title("storage.create_account", config.getName());
