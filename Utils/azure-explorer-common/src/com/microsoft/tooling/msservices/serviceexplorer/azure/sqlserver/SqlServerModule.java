...
public class SqlServerModule extends AzureRefreshableNode {
    ...
    public SqlServerModule(final Node parent) {
        ...
        AzureEventBus.after("sqlserver.create_server.server", this::onServerCreatedOrRemoved);
        AzureEventBus.after("sqlserver.delete_server.server", this::onServerCreatedOrRemoved);
    }
